...
public class MBoardListVO {
	...
	public String toString() {
		return "MBoardListVO [admin_notice_seq=" + admin_notice_seq + ", admin_notice_date=" + admin_notice_date
				+ ", admin_notice_category=" + admin_notice_category + ", admin_notice_title=" + admin_notice_title
				+ ", admin_notice_content=" + admin_notice_content + ", admin_notice_coupon=" + admin_notice_coupon
				+ "]";
	}
